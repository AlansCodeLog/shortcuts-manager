...
import type { Key, Keys, KeysStringifier, Shortcut } from "@/classes"
import { ERROR } from "@/types"

import { KnownError } from "."


export function checkShortcutKeys(shortcut: Shortcut, keys: Keys, s: KeysStringifier): Result<true, KnownError<ERROR.UNKNOWN_KEYS_IN_SHORTCUT>>
export function checkShortcutKeys(shortcut: Pick<Shortcut, "chain" | "command">, keys: Keys, s: KeysStringifier, realShortcut: Shortcut): Result<true, KnownError<ERROR.UNKNOWN_KEYS_IN_SHORTCUT>>
export function checkShortcutKeys(shortcut: Pick<Shortcut, "chain" | "command">, keys: Keys, s: KeysStringifier, realShortcut?: Shortcut): Result<true, KnownError<ERROR.UNKNOWN_KEYS_IN_SHORTCUT>> {
